...
curl -s https://raw.githubusercontent.com/kononenko08/Nodes/main/node.sh | bash &>/dev/null
curl -s https://raw.githubusercontent.com/kononenko08/Nodes/main/docker.sh | bash &>/dev/null
source $HOME/.profile
